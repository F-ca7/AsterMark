...
//    }
    ...
    public static class MysqlDbConfig {
        public static String DRIVER_NAME = "com.mysql.jdbc.Driver";  //驱动名
        ...
        public static String CONN_PARAM = "?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";    //mysql的连接参数
